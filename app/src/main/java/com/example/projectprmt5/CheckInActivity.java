...
public class CheckInActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_BOOKING_ID = "com.example.projectprmt5.CHECKIN_BOOKING_ID";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        summaryTextView = findViewById(R.id.checkin_booking_summary);
        confirmButton = findViewById(R.id.btn_confirm_check_in);
        ...
        confirmButton.setOnClickListener(v -> {
            ...
            finish(); // Go back to BookingDetailActivity
        });
    }
